...
%         (MANDATORY)
        dir_metabolite    = dir([data_folder filesep subs(kk).name filesep 'mrs' filesep subs(kk).name '*pcc30ms.7']); 
...
% (MANDATORY) 
outputFolder = '/Volumes/LaCie/Projects/mrs_development/BIOE_test_jan2025/pcc30ms/';

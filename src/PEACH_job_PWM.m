...
%   To run do: MRSCont = RunOspreyJob('PEACH_job_PWM.m')
...
% Specify metabolite data
files = {'/Volumes/BIDS/CL_PEACH/sub-31025/ses-03/mrs/sub-31025_ses-03_slaser_pwm.7'};
...
% (MANDATORY)
outputFolder = '/Volumes/LaCie/Projects/mrs_development/PEACH/PWM/';
